          ...
          <div style={{
            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
                <thead>
                  <tr>
                    <th style={{ textAlign: 'left', padding: '6px 8px', color: '#9CA3AF', fontWeight: '600', borderBottom: '1px solid var(--color-border)' }}>Profile</th>
                    <th style={{ textAlign: 'left', padding: '6px 8px', color: '#9CA3AF', fontWeight: '600', borderBottom: '1px solid var(--color-border)' }}>CI target</th>
                    <th style={{ textAlign: 'left', padding: '6px 8px', color: '#9CA3AF', fontWeight: '600', borderBottom: '1px solid var(--color-border)' }}>Life/TPD target</th>
                  </tr>
                </thead>
                <tbody>
                  {Object.entries(RISK_PROFILES).map(([key, profile]) => (
                    <tr key={key}>
                      <td style={{ padding: '8px', borderBottom: '1px solid var(--color-border)', color: 'var(--color-primary)', fontWeight: '600' }}>
                        {profile.label}
                        {key === 'balanced' && (
                          <span style={{ marginLeft: '6px', fontSize: '11px', fontWeight: '500', color: '#9CA3AF' }}>(default)</span>
                        )}
                      </td>
                      <td style={{ padding: '8px', borderBottom: '1px solid var(--color-border)', color: '#374151' }}>{profile.ciMultiple}× income</td>
                      <td style={{ padding: '8px', borderBottom: '1px solid var(--color-border)', color: '#374151' }}>{profile.lifeMultiple}× income</td>
                    </tr>
                  ))}
                </tbody>
              </table>
